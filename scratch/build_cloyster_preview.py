...
<body>
  ...
  <script>
    ...
    function playClamp() {{
      ...
      maw.innerHTML = `<img src="${{clampMawSrc}}" style="width: 110px; height: 110px; object-fit: contain; filter: drop-shadow(0 0 20px #7c3aed) drop-shadow(0 0 12px #38bdf8);" />`;
...
print("Successfully generated public/preview_cloyster.html")
